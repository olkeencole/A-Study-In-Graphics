...
mkdir build
pushd build
cl  -FC -Zi /I C:\VulkanSDK\1.0.65.0\Include\ /I ..\include  ..\vkTriangle.cpp -W2 -wd4312 user32.lib  ..\library\glfw3dll.lib  gdi32.lib kernel32.lib  C:\VulkanSDK\1.0.65.0\Lib\vulkan-1.lib
popd
